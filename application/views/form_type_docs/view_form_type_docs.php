    ...
    <section class="content">
      <div class="box box-success">
            <div class="box-header">
              <h3 class="box-title pull-left"><?php echo ucwords(str_replace('_', ' ', 'form_type_docs detail')); ?></h3>
            ...
            <div class="box-body table-responsive">
              <table id="ssp_datatable" class="table table-bordered table-striped table-hover table-condensed">
                ...
                <tr>
                  ...
                  <th width="10%"><?php echo ucwords(str_replace('_', ' ', 'form_type_docs name')); ?></th>
                  <th width="10%"><?php echo ucwords(str_replace('_', ' ', 'form_type')); ?></th>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title"><?php echo ucwords(str_replace('_', ' ', 'edit form_type_docs')); ?></h4>
      ...
      <div class="modal-body">
            ...
            <div class="form-group">
                  <label class="label-control col-md-4"><?php echo $label = ucwords(str_replace('_', ' ', 'form_type')); ?>:</label>
                  <div class="col-md-8">
                  <div class="input-group">
                  <div class="input-group-addon">
                    <i class="fa fa-book"></i>
                  </div>
                  <select  name="tbl_form_type_id" id="tbl_form_type_id" class="form-control select2 validate[required]" style="width: 100%">
            ...
            <div class="form-group">
                  <label class="label-control col-md-4"><?php echo $label = ucwords(str_replace('_', ' ', 'form_type_docs name')); ?>:</label>
                  <div class="col-md-8">
                  <div class="input-group">
                  <div class="input-group-addon">
...
$(document).ready(function(){
    sspDataTable=$('#ssp_datatable').DataTable({
        ...
        "ajax": {
            "url": "<?php echo base_url('form_type_docs/get_form_type_docs/'); ?>",
            "type": "POST"
        },
...
function save()
    {
      ...
      if(save_method == 'add')
      {
        url = "<?php echo site_url('form_type_docs/add_form_type_docs') ?>";
      }
      else
      {
        url = "<?php echo site_url('form_type_docs/update_form_type_docs') ?>";
      }
...
function add()
    {
      ...
      $('.modal-title').text('<?php echo ucwords(str_replace('_', ' ', 'add new form_type_docs')); ?>'); // Set Title to Bootstrap modal title
...
function form_reset()
    ...
    $('#formID')[0].reset(); // reset form on modals
      $('#tbl_form_type_id').val('').trigger('change');
      $('#error').html(" ");
      $('div[id=error]').html(" ");
...
// getData function for get data for editment and updating
  function getData(id)
  {
      ...
      $.ajax({
        url : "<?php echo site_url('form_type_docs/getData/') ?>/" + id,
        type: "post",
        dataType: "JSON",
        success: function(data)
        {
          ...
          $('#tbl_form_type_id').val(data.tbl_form_type_id).trigger('change');
