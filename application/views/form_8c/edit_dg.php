<div class="content-wrapper">
    ...
    <?php echo form_open_multipart('form_8c/edit_dg', 'id="formID"'); ?>
            ...
            <div class="col-md-6 no-print">
              <div class="table-responsive">
                    <table class="table table-bordered table-striped table-hover table-condensed">
                      ...
                      <?php $getDocs = $this->global->getAllRecordByArray('tbl_form_8c_apply_documents', array('tbl_form_8c_id' => $all['id']));?>

                      <?php foreach ($getDocs as $key => $getDocsInfo) {?>
                      <tr>
                        <td class="tdva"><?php echo $getDocsInfo['document_name']; ?></td>
                        <td class="tdvb"><a target="_blank" href="<?php echo base_url() . IMG_UPLOAD_PATH . 'form_8c/' . $getDocsInfo['uploaded_document']; ?>">Uploaded <?php echo $getDocsInfo['document_name']; ?></a></td>
                      </tr>
                    <?php }?>
                    </table>
                    </div>
  ...
  <div class="box box-info">
        ...
        <div class="box-body">
          <div class="row">
            ...
            <input type="hidden" name="tbl_form_type_id" id="tbl_form_type_id" value="3">
            <input type="hidden" name="tbl_name" id="tbl_name" value="tbl_form_8c">
...
<?php if ($all['status'] != 1 && $all['status'] != 4 && $getPharmacist['is_verify'] == 'yes') {?>
    ...
    <a href="<?php echo base_url(view_form_8c); ?>" class="btn btn-danger  btn-sm" type="button"> <i class="fa fa-chevron-left"> </i> Cancel/Back</a>
          </div>
<?php } else {?>

      <div class="col-xs-12 text-right">
    <a href="<?php echo base_url('view_form_8c'); ?>" class="btn btn-danger  btn-sm" type="button"> <i class="fa fa-chevron-left"> </i> Back</a>
