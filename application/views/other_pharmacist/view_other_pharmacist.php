    ...
    <section class="content">
      <div class="box box-success">
            <div class="box-header">
              <h3 class="box-title pull-left"><?php echo ucwords(str_replace('_', ' ', 'non KP Qualified person detail')); ?></h3>
            ...
            <div class="box-body table-responsive">
              <table id="ssp_datatable" class="table table-bordered table-striped table-hover table-condensed">
                ...
                <tr>
                  ...
                  <th width="6%"><?php echo ucwords(str_replace('_', ' ', 'country / province')); ?></th>
      ...
      <div class="modal-body">
        <div class="table-responsive">
          <table class="table table-bordered table-striped table-hover table-condensed">
            ...
            <tr>
              <td class="tdva"><?php echo ucwords(str_replace('_', ' ', 'country')); ?></td>
              <td class="tdvb country"></td>
              <td class="tdva"><?php echo ucwords(str_replace('_', ' ', 'province')); ?></td>
              <td class="tdvb province"></td>
            </tr>
            <tr>
              <td class="tdva"><?php echo ucwords(str_replace('_', ' ', 'institute')); ?></td>
              <td class="tdvb institute"></td>
              <td class="tdva"><?php echo ucwords(str_replace('_', ' ', 'qualification')); ?></td>
              <td class="tdvb qualification"></td>
            </tr>
            <tr>
              <td class="tdva"><?php echo ucwords(str_replace('_', ' ', 'category')); ?></td>
              <td class="tdvb category"></td>
            ...
            <tr>
              <td class="tdva"><?php echo ucwords(str_replace('_', ' ', 'detail')); ?></td>
              <td class="tdvb detail"></td>
...
<div class="form-group">
  ...
  <div class="col-md-8">
    <div class="input-group">
      ...
      <!-- <div id="error"></div> -->
      <input type="text" autocomplete="off" value="<?php echo set_value('name'); ?>" name="name" id="name" class="form-control validate[required,minSize[3],maxSize[50]]" placeholder="Enter <?php echo $label; ?>" />
...
<div class="form-group">
  ...
  <div class="col-md-8">
    <div class="input-group">
      ...
      <input type="text" autocomplete="off" value="<?php echo set_value('father_name'); ?>" name="father_name" id="father_name" class="form-control validate[required,minSize[3],maxSize[50]]" placeholder="Enter <?php echo $label; ?>" />
    </div>
    <div id="error"></div>
  </div>
</div>
...
<div class="form-group">
  <label class="label-control col-md-4"><?php echo $label = ucwords(str_replace('_', ' ', 'country')); ?>:</label>
  <div class="col-md-8">
    <div class="input-group">
      <div class="input-group-addon">
        <i class="fa fa-flag"></i>
      </div>
      <input type="text" autocomplete="off" value="<?php echo set_value('country'); ?>" name="country" id="country" class="form-control validate[required,minSize[3],maxSize[50]]" placeholder="Enter <?php echo $label; ?>" />
    </div>
    <div id="error"></div>
  </div>
</div>
...
<div class="form-group">
  ...
  <div class="col-md-8">
    <div class="input-group">
      ...
      <input type="text" autocomplete="off" value="<?php echo set_value('province'); ?>" name="province" id="province" class="form-control validate[required,minSize[3],maxSize[50]]" placeholder="Enter <?php echo $label; ?>" />
    </div>
    <div id="error"></div>
  </div>
</div>
...
<!-- <div class="form-group">
  ...
  <div class="col-md-8">
    <div class="input-group">
      ...
      <input type="text" readonly autocomplete="off" value="<?php echo set_value('dob'); ?>" name="dob" id="dob" class="form-control validate[required,minSize[3],maxSize[50]]" placeholder="Enter <?php echo $label; ?>" />
      </div><div id="error"></div>
    </div>
  </div> -->
...
<div class="form-group">
  ...
  <div class="col-md-8">
    <div class="input-group">
      ...
      <input type="text" autocomplete="off" value="<?php echo set_value('qualification'); ?>" name="qualification" id="qualification" class="form-control validate[required,minSize[3],maxSize[50]]" placeholder="Enter <?php echo $label; ?>" />
    </div>
    <div id="error"></div>
  </div>
</div>
...
<div class="form-group">
  ...
  <div class="col-md-8">
    <div class="input-group">
      ...
      <input type="text" autocomplete="off" value="<?php echo set_value('institute'); ?>" name="institute" id="institute" class="form-control validate[required,minSize[3],maxSize[50]]" placeholder="Enter <?php echo $label; ?>" />
    </div>
    <div id="error"></div>
  </div>
</div>
...
<div class="form-group">
  ...
  <div class="col-md-8">
    <div class="input-group">
      ...
      <input type="text" autocomplete="off" value="<?php echo set_value('category'); ?>" name="category" id="category" class="form-control validate[required,minSize[3],maxSize[50]]" placeholder="Enter <?php echo $label; ?>" />
    </div>
    <div id="error"></div>
  </div>
</div>
...
<!-- <div class="form-group">
  ...
  <div class="col-md-8">
    <div class="input-group">
      ...
      <input type="text" readonly autocomplete="off" value="<?php echo set_value('graduation_date'); ?>" name="graduation_date" id="graduation_date" class="form-control validate[required,minSize[3],maxSize[50]]" placeholder="Enter <?php echo $label; ?>" />
      </div><div id="error"></div>
    </div>
  </div> -->
  ...
  <div class="col-md-8">
    <div class="input-group">
      ...
      <input type="text" readonly autocomplete="off" value="<?php echo set_value('passing_year'); ?>" name="passing_year" id="passing_year" class="form-control validate[required,minSize[3],maxSize[50]]" placeholder="Enter <?php echo $label; ?>" />
      </div><div id="error"></div>
    </div>
  </div> -->
...
<div class="form-group">
  ...
  <div class="col-md-8">
    <div class="input-group">
      ...
      <input type="text" autocomplete="off" value="<?php echo set_value('pharmacy_reg_no'); ?>" name="pharmacy_reg_no" id="pharmacy_reg_no" class="form-control validate[required,minSize[3],maxSize[50]]" placeholder="Enter <?php echo $label; ?>" />
      </div><div id="error"></div>
    </div>
  </div>
...
<div class="form-group">
  ...
  <div class="form-group">
  <label class="label-control col-md-4"><?php echo $label = ucwords(str_replace('_', ' ', 'detail')); ?>:</label>
  <div class="col-md-8">
    <div class="input-group">
      <div class="input-group-addon">
      ...
      <textarea autocomplete="off" name="detail" id="detail" class="form-control validate[required,minSize[3],maxSize[50]]"></textarea>
      </div><div id="error"></div>
    </div>
  </div>
...
$(document).ready(function(){
    sspDataTable=$('#ssp_datatable').DataTable({
        ...
        "ajax": {
            "url": "<?php echo base_url('other_pharmacist/get_other_pharmacist/'); ?>",
            "type": "POST"
        },
...
function save()
    {
      ...
      if(save_method == 'add')
      {
        url = "<?php echo site_url('other_pharmacist/add_other_pharmacist') ?>";
      }
      else
      {
        url = "<?php echo site_url('other_pharmacist/update_other_pharmacist') ?>";
      }
...
function add()
    {
      ...
      $('.modal-title').text('<?php echo ucwords(str_replace('_', ' ', 'add new non KP qualified person')); ?>'); // Set Title to Bootstrap modal title
...
// getData function for get data for editment and updating
  function getData(id)
  {
      ...
      $.ajax({
        ...
        success: function(data)
        {
          ...
          // $('#tbl_other_pharmacist_category_id').val(data.tbl_other_pharmacist_category_id).trigger('change');
          ...
          $('input[name^="status"][value="'+data.status+'"').prop('checked',true);
            ...
            $('.modal-title').text('<?php echo ucwords(str_replace('_', ' ', 'edit non KP qualified person')); ?>'); // Set Title to Bootstrap modal title
    ...
    function getShowData(id)
  {
      ...
      //Ajax Load data from ajax
      $.ajax({
        url : "<?php echo site_url('other_pharmacist/fetchData/') ?>/" + id,
        type: "post",
        dataType: "JSON",
        success: function(data)
        {
          ...
          if(data.status=='1'){
            ...
            $('.modal-title').text('<?php echo ucwords(str_replace('_', ' ', 'non KP qualified person detail')); ?>'); // Set Title to Bootstrap modal title
