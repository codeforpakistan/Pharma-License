                  ...
                  <table style="table-layout: fixed;" class="table table-condensed">
                    <tr>
                      ...
                      <td class="tdvb text-right"><br>
                        ...
                        <br>License: <u>Pharmacy/<?php echo $all['tracking_code']; ?></u>
                    ...
                    <tr>
                      <td colspan="3" class="tdvb text-justify">
                        <ol>
                          <li style="white-space:normal;">License to sell drugs in Pharmacy, <b><u> <?php echo $getProprietor['name'] ?> S/O <?php echo $getProprietor['father_name'] ?> Prop: M/S <?php echo $getProprietor['business_name'] ?> </u></b> is hereby licensed to compound ot prepare on prescription the drugs and distribute drugs by way of retail sale on the premises situated at <b><u> <?php echo ucwords($getProprietor['business_address']) ?> </u></b> subject to conditions specified below and to the provision of Drugs Act, 1976 and the rules made there under.
                          </li>
                          <br>
                          <br>
                          ...
                          <br>
                          <br>
                          <li>Registration No <b><u><?php echo $getPharmacist['pharmacy_reg_no']; ?></u></b> with <?php if ($getPharmacist['tbl_pharmacist_category_id']) {?><?php $getCategory = $this->global->getRecordByArray('tbl_pharmacist_category', array('id' => $getPharmacist['tbl_pharmacist_category_id']));?><u><b><?php echo $getCategory['name']; ?></b></u><?php } else {?><u><b><?php echo $getPharmacist['category']; ?></b></u><?php }?>
                          </li>
                          <br>
                          <br>
