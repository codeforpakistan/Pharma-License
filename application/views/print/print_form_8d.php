              ...
              <div class="col-md-12">
                <div class="table-responsive">
                  <table style="table-layout: fixed;" class="table table-condensed">
                    <tr>
                      <td class="tdva text-left"><br><img src="<?php echo base_url() . IMG_UPLOAD_PATH . 'pharmacist/' . $getPharmacist['image']; ?>" height="100px" width="100px" class="img-thumbnail">
                        <br>
                        Qualified Person
                        <br>
                        &nbsp;
                      </td>
                      <td class="tdvb text-center"><b><u>Form - 11</u></b></td>
                      <td class="tdvb text-right"><br>
                        ...
                        <br>License: <u>Narcotics/<?php echo $all['tracking_code']; ?></u>
                        <br> Date: <u><?php echo date('d/m/Y'); ?></u>
                      </td>
                    </tr>
                    <tr>
                      <td colspan="3" class="tdvb text-center">{(See Rules 15(3))}</td>
                    </tr>
                    <tr>
                      <td colspan="3" class="tdva text-center" style="white-space:normal;">LICENSE TO SELL NARCOTICS AND OTHER DRUGS SPECIFIED IN SCHEDULE B</td>
                    </tr>
                    <tr>
                      <td colspan="3" class="tdvb text-justify">
                        <ol>
                          <li style="white-space:normal;">
                 <b><u><?php echo $getProprietor['name']; ?> S/O <?php echo $getProprietor['father_name']; ?> Prop: M/S <?php echo $getProprietor['business_name']; ?> </u></b> is hereby licensed to is holder of License No. <b><u><?php echo date('y') . $all['id'] . '/' . date('m'); ?></u></b> on form- 9/10 is licensed to sell stock narcotics and other drugs specified in schedule B on the premises situated at <b><u> <?php echo ucwords($getProprietor['business_address']); ?> </u></b> subject to conditions specified below and to the provision of Drugs Act, 1976 and the rules made there under.
                </li>
                          <br>
                          <br>
                          <li>This License will be force for two years from the date given below or till validity of License in Form- 9/10.</li>
                          <br>
                          <br>
