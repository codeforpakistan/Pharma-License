...
<?php $all = $this->global->getRecordByArray('tbl_form_8c', array('id' => $id));?>
  ...
  <?php $getDates = $this->global->getRecordByArray('tbl_application_renewel', array('tbl_name' => 'tbl_form_8c', 'tbl_name_id' => $id));?>
                ...
                <div class="table-responsive">
                  <table style="table-layout: fixed;" class="table table-condensed">
                    <tr>
                      ...
                      <td class="tdvb text-center"><b><u>Form - 10</u></b></td>
                      <td class="tdvb text-right"><br>
                        ...
                        <br>License: <u>whole Sale/<?php echo $all['tracking_code']; ?></u>
