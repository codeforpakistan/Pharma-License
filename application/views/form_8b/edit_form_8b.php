<div class="content-wrapper">
    ...
    <?php echo form_open_multipart('form_8b/edit_form_8b', 'id="formID"'); ?>
        ...
        <div class="box-body">
          <div class="row">
            ...
            <div class="col-md-12">
                ...
                <input type="hidden" id="tbl_form_type_id" name="tbl_form_type_id" value="2">
            ...
            <div class="col-md-12">
              ...
              <div class="form-group">
                ...
                <div class="form-group">
                  ...
                  <input type="text" autocomplete="off" value="<?php echo $getPharmacist['pharmacy_reg_no']; ?>" name="reg_no" id="reg_no" class="form-control validate[required,minSize[3]" placeholder="Enter <?php echo $label; ?>" />
...
<div class="col-md-6">
  ...
  <div class="box box-success">
        ...
        <div class="box-body">
          <div class="row">
            <?php $getFormTypeDoc = $this->global->getFormTypeDocForm8b($all['id']);?>
            ...
            <div class="col-md-12">
              ...
              <div class="form-group">
                ...
                <a id="" href="<?php echo base_url() . IMG_UPLOAD_PATH . 'form_8b/' . $form_type_docInfo['uploaded_document']; ?>" target="_blank">Click here for Uploaded Document <?php echo $form_type_docInfo['name']; ?></a>
              <?php }?>
                ...
                <input type='hidden' name='tbl_form_8b_apply_documents<?php echo $form_type_docInfo['tblForm8bApplyDocID']; ?>' id='tbl_form_8b_apply_documents<?php echo $form_type_docInfo['tblForm8bApplyDocID']; ?>' value='<?php echo $form_type_docInfo['tblForm8bApplyDocID']; ?>'>

                <!-- <input type='hidden' name='tbl_form_8b_apply_documents[]' id='tbl_form_8b_apply_documents[]' value='<?php echo $form_type_docInfo['tblForm8bApplyDocID']; ?>'> -->
