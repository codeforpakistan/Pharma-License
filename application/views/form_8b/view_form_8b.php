    ...
    <section class="content">
      <div class="box box-success">
            <div class="box-header">
              <h3 class="box-title pull-left"><?php echo ucwords(str_replace('_', ' ', 'form 8B - Retail Store Detail')); ?></h3>
             <!--  <h3 class="box-title pull-right">
                ...
                <a href="<?php echo base_url('add_form_8b'); ?>" type="button" class="btn btn-block btn-success btn-sm"><i class="fa fa-plus"> New </i></a><?php }?>
              </h3>
...
$(document).ready(function(){
    sspDataTable=$('#ssp_datatable').DataTable({
        ...
        "ajax": {
            "url": "<?php echo base_url('form_8b/get_form_8b/'); ?>",
            // "type": "POST"
            'data': function(data){
