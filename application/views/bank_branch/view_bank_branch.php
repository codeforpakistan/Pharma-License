    ...
    <section class="content">
      <div class="box box-success">
            <div class="box-header">
              <h3 class="box-title pull-left"><?php echo ucwords(str_replace('_', ' ', 'bfc banks branches detail')); ?></h3>
            ...
            <div class="box-body table-responsive">
              <table id="ssp_datatable" class="table table-bordered table-striped table-hover table-condensed">
                ...
                <tr>
                  ...
                  <th width="8%"><?php echo ucwords(str_replace('_', ' ', 'branch name')); ?></th>
                  <th width="8%"><?php echo ucwords(str_replace('_', ' ', 'branch code')); ?></th>
                  <th width="8%"><?php echo ucwords(str_replace('_', ' ', 'Bank')); ?></th>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title"><?php echo ucwords(str_replace('_', ' ', 'edit bfc bank branch')); ?></h4>
      ...
      <div class="modal-body">
            ...
            <div class="form-group">
                  <label class="label-control col-md-4"><?php echo $label = ucwords(str_replace('_', ' ', 'Banks')); ?>:</label>
                  <div class="col-md-8">
                  <div class="input-group">
                  <div class="input-group-addon">
                    <i class="fa fa-bank"></i>
                  </div>
                  <select  name="tbl_banks_id" id="tbl_banks_id" class="form-control select2 validate[required]" style="width: 100%">
                    <option value="">Select Bank</option>

                    <?php foreach ($banks as $banksInfo): ?>
                      <option value="<?php echo $banksInfo['id']; ?>"><?php echo $banksInfo['name']; ?></option>
                    <?php endforeach;?>
            ...
            <div class="form-group">
                  <label class="label-control col-md-4"><?php echo $label = ucwords(str_replace('_', ' ', 'Bank branch name')); ?>:</label>
                  <div class="col-md-8">
                  <div class="input-group">
                  <div class="input-group-addon">
                    <i class="fa fa-bank"></i>
            ...
            <div class="form-group">
                  <label class="label-control col-md-4"><?php echo $label = ucwords(str_replace('_', ' ', 'bank branch code')); ?>:</label>
                  <div class="col-md-8">
                  <div class="input-group">
                  <div class="input-group-addon">
                    <i class="fa fa-bank"></i>
                  ...
                  <!-- <div id="error"></div> -->
                  <input type="text" autocomplete="off" value="<?php echo set_value('branch_code'); ?>" name="branch_code" id="branch_code" class="form-control validate[required,minSize[3],maxSize[25]]" placeholder="Enter <?php echo $label; ?>" />
                </div><div id="error"></div>
                </div>
...
$(document).ready(function(){
    sspDataTable=$('#ssp_datatable').DataTable({
        ...
        "ajax": {
            "url": "<?php echo base_url('bank_branch/get_bank_branch/'); ?>",
            "type": "POST"
        },
...
function save()
    {
      ...
      if(save_method == 'add')
      {
        url = "<?php echo site_url('bank_branch/add_bank_branch') ?>";
      }
      else
      {
        url = "<?php echo site_url('bank_branch/update_bank_branch') ?>";
      }
...
function add()
    {
      ...
      $('.modal-title').text('<?php echo ucwords(str_replace('_', ' ', 'add new bank branch')); ?>'); // Set Title to Bootstrap modal title
    }

function form_reset()
    {
    $('#formID')[0].reset(); // reset form on modals
      $('#tbl_banks_id').val('').trigger('change');
      $('#error').html(" ");
      $('div[id=error]').html(" ");
...
// getData function for get data for editment and updating
  function getData(id)
  {
      ...
      $.ajax({
        url : "<?php echo site_url('bank_branch/getData/') ?>/" + id,
        type: "post",
        dataType: "JSON",
        success: function(data)
        {
          ...
          $('#tbl_banks_id').val(data.tbl_banks_id).trigger('change');
