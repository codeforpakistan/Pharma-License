    ...
    <section class="content">
      <div class="box box-success">
            <div class="box-header">
              <h3 class="box-title pull-left"><?php echo ucwords(str_replace('_', ' ', 'categories detail')); ?></h3>
            ...
            <div class="box-body table-responsive">
              <table id="ssp_datatable" class="table table-bordered table-striped table-hover table-condensed">
                ...
                <tr>
                  ...
                  <th width="10%"><?php echo ucwords(str_replace('_', ' ', 'category name')); ?></th>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title"><?php echo ucwords(str_replace('_', ' ', 'edit category')); ?></h4>
      ...
      <div class="modal-body">
            ...
            <div class="form-group">
                  ...
                  <label class="label-control col-md-4"><?php echo $label = ucwords(str_replace('_', ' ', 'category name')); ?>:</label>
                  <div class="col-md-8">
                  ...
                  <!-- <div id="error"></div> -->
                  <input type="text" autocomplete="off" value="<?php echo set_value('name'); ?>" name="name" id="name" class="form-control validate[required,minSize[1],maxSize[25]]" placeholder="Enter <?php echo $label; ?>" />
...
$(document).ready(function(){
    sspDataTable=$('#ssp_datatable').DataTable({
        ...
        "ajax": {
            "url": "<?php echo base_url('pharmacist_category/get_pharmacist_category/'); ?>",
            "type": "POST"
        },
...
function save()
    {
      ...
      if(save_method == 'add')
      {
        url = "<?php echo site_url('pharmacist_category/add_pharmacist_category') ?>";
      }
      else
      {
        url = "<?php echo site_url('pharmacist_category/update_pharmacist_category') ?>";
      }
...
function add()
    {
      ...
      $('.modal-title').text('<?php echo ucwords(str_replace('_', ' ', 'add new category')); ?>'); // Set Title to Bootstrap modal title
    }
...
// getData function for get data for editment and updating
  function getData(id)
  {
      ...
      $.ajax({
        url : "<?php echo site_url('pharmacist_category/getData/') ?>/" + id,
        type: "post",
        dataType: "JSON",
        success: function(data)
        {
