...
<html>
  <head>
    ...
    <title>Registration | Drug Control & Pharmacy Services Health Department KP</title>
  ...
  <style type="text/css">
  .login-background {
  background-image: url(<?php echo base_url('assets/upload/images/registration-bg.jpeg'); ?>);
...
<div class="login-box" style="background-color: white; opacity: 0.8">
  <div class="login-logo">
  ...
  </a></div><div class="login-box-body">
    <?php $this->load->view('templates/alerts');?>
    <p class="login-box-msg">Register Your Self</p>
    <?php validation_errors();?>
    <?php echo form_open_multipart('registration', 'id="formID"'); ?>

    <div class="row">
      <div class="col-md-12">
        <div class="form-group has-feedback">
          <input type="text" class="form-control validate[required,minSize[3],maxSize[20]]" value="<?php echo set_value('name'); ?>" autocomplete="off" name="name" id="name" placeholder="Full Name">
          <span class="glyphicon glyphicon-user form-control-feedback"></span>
          <?php echo form_error('name'); ?>
        </div>
        <div class="form-group has-feedback">
          <input type="text" class="form-control validate[required,minSize[3],maxSize[20],custom[onlyLetterNumber]]" value="<?php echo set_value('username'); ?>" autocomplete="off"  name="username" id="username" placeholder="Username" data-errormessage-custom-error="No spaces and special Characters are allowed">
          <span class="glyphicon glyphicon-envelope form-control-feedback"></span>
          <?php echo form_error('username'); ?>
        </div>
        <div class="form-group has-feedback">
        <input type="password" class="form-control validate[required,minSize[3],maxSize[15],custom[onlyLetterNumber]]" value="<?php echo set_value('password'); ?>"  name="password"  id="password" placeholder="Password" data-errormessage-custom-error="No spaces and special Characters are allowed">
        <span class="glyphicon glyphicon-lock form-control-feedback"></span>
        <?php echo form_error('password'); ?>
      </div>
      <div class="form-group has-feedback">
        <input type="password" class="form-control validate[required,minSize[3],maxSize[15]]" value="<?php echo set_value('confirm_password'); ?>"  name="confirm_password"  id="confirm_password" placeholder="Confirm Password">
        <span class="glyphicon glyphicon-lock form-control-feedback"></span>
        <?php echo form_error('confirm_password'); ?>
      </div>

      <div class="form-group has-feedback">
        <input type="text" class="form-control validate[required,minSize[3],custom[email]]" value="<?php echo set_value('email'); ?>" autocomplete="off"  name="email" id="email" placeholder="Email" data-errormessage-custom-error="Let me give you a hint: someone@nowhere.com">
        <span class="glyphicon glyphicon-envelope form-control-feedback"></span>
      ...
      <div class="form-group has-feedback">
        ...
        <?php echo form_error('tbl_district_id'); ?>
      </div>
    ...
    <div class="row">
      ...
      <div class="col-xs-12 pull-right">
        <button type="submit" id="submit" value="submit" name="submit" class="btn btn-primary btn-block btn-flat">Register</button>
      </div>
      <br><br>
      <p class="login-box-msg">Already have an account? <a href="<?php echo base_url('login'); ?>">Sign In</a></p>
    </div>
  </form>
  <?php echo form_close(); ?>
</div>
<!-- /.login-box-body -->
  ...
  jQuery("#formID").validationEngine('attach', {autoHidePrompt:true,autoHideDelay:5000,promptPosition : "topLeft", scroll: false});
