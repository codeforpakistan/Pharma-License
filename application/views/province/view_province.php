    ...
    <section class="content">
      <div class="box box-success">
            <div class="box-header">
              <h3 class="box-title pull-left"><?php echo ucwords(str_replace('_', ' ', 'province detail')); ?></h3>
            ...
            <div class="box-body table-responsive">
              <table id="ssp_datatable" class="table table-bordered table-striped table-hover table-condensed">
                ...
                <tr>
                  ...
                  <th width="15%"><?php echo ucwords(str_replace('_', ' ', 'province name')); ?></th>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title"><?php echo ucwords(str_replace('_', ' ', 'edit province')); ?></h4>
      ...
      <div class="modal-body">
            ...
            <div class="form-group">
                  <label class="label-control col-md-4"><?php echo $label = ucwords(str_replace('_', ' ', 'province name')); ?>:</label>
                  <div class="col-md-8">
...
$(document).ready(function(){
    sspDataTable=$('#ssp_datatable').DataTable({
        ...
        "ajax": {
            "url": "<?php echo base_url('province/get_province/'); ?>",
            "type": "POST"
        },
...
function save()
    {
      ...
      if(save_method == 'add')
      {
        url = "<?php echo site_url('province/add_province') ?>";
      }
      else
      {
        url = "<?php echo site_url('province/update_province') ?>";
      }
...
function add()
    {
      ...
      $('.modal-title').text('<?php echo ucwords(str_replace('_', ' ', 'add new province')); ?>'); // Set Title to Bootstrap modal title
...
// getData function for get data for editment and updating
  function getData(id)
  {
      ...
      $.ajax({
        url : "<?php echo site_url('province/getData/') ?>/" + id,
        type: "post",
        dataType: "JSON",
        success: function(data)
        {
          ...
          $('.modal-title').text('<?php echo ucwords(str_replace('_', ' ', 'Edit province')); ?>'); // Set Title to Bootstrap modal title
