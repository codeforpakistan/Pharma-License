    ...
    <section class="content">
      <div class="box box-success">
            <div class="box-header">
              <h3 class="box-title pull-left"><?php echo ucwords(str_replace('_', ' ', 'district detail')); ?></h3>
            ...
            <div class="box-body table-responsive">
              <table id="ssp_datatable" class="table table-bordered table-striped table-hover table-condensed">
                ...
                <tr>
                  ...
                  <th width="10%"><?php echo ucwords(str_replace('_', ' ', 'province name')); ?></th>
                  <th width="10%"><?php echo ucwords(str_replace('_', ' ', 'district name')); ?></th>
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
            ...
            <div class="form-group">
                  ...
                  <select  name="tbl_province_id" id="tbl_province_id" class="form-control select2 validate[required]" style="width: 100%">
  ...
  function getData(id)
  {
      ...
      $.ajax({
        ...
        success: function(data)
        {
          ...
          $('.modal-title').text('<?php echo ucwords(str_replace('_', ' ', 'Edit district')); ?>'); // Set Title to Bootstrap modal title
