    ...
    <section class="content">
      <div class="box box-success">
            <div class="box-header">
              <h3 class="box-title pull-left"><?php echo ucwords(str_replace('_', ' ', 'user roles detail')); ?></h3>
            ...
            <div class="box-body table-responsive">
              <table id="ssp_datatable" class="table table-bordered table-striped table-hover table-condensed">
                ...
                <tr>
                  ...
                  <th width="15%"><?php echo ucwords(str_replace('_', ' ', 'role name')); ?></th>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title"><?php echo ucwords(str_replace('_', ' ', 'edit role')); ?></h4>
      ...
      <div class="modal-body">
            ...
            <div class="form-group">
                  ...
                  <label class="label-control col-md-4"><?php echo $label = ucwords(str_replace('_', ' ', 'role name')); ?>:</label>
                  <div class="col-md-8">
...
$(document).ready(function(){
    sspDataTable=$('#ssp_datatable').DataTable({
        ...
        "ajax": {
            "url": "<?php echo base_url('role/get_role/'); ?>",
            "type": "POST"
        },
...
function save()
    {
      ...
      {
        url = "<?php echo site_url('role/update_role') ?>";
      }
...
function add()
    {
      ...
      $('.modal-title').text('<?php echo ucwords(str_replace('_', ' ', 'add new role')); ?>'); // Set Title to Bootstrap modal title
...
// getData function for get data for editment and updating
  function getData(id)
  {
      ...
      $.ajax({
        url : "<?php echo site_url('role/getData/') ?>/" + id,
        type: "post",
        dataType: "JSON",
        success: function(data)
        {
