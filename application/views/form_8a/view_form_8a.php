    ...
    <section class="content">
      <div class="box box-success">
            <div class="box-header">
              <h3 class="box-title pull-left"><?php echo ucwords(str_replace('_', ' ', 'form 8A - Pharmacy Licenses Detail')); ?></h3>
             <!--  <h3 class="box-title pull-right">
                ...
                <a href="<?php echo base_url('add_form_8a'); ?>" type="button" class="btn btn-block btn-success btn-sm"><i class="fa fa-plus"> New </i></a><?php }?>
              </h3>
...
.open .dropdown-menu:nth-last-child(1){
  display: flex;
