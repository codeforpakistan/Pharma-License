<div class="content-wrapper">
    ...
    <?php echo form_open_multipart('form_8a/edit_dg', 'id="formID"'); ?>
  ...
  <div class="box box-info">
        ...
        <div class="box-body">
          <div class="row">
            ...
            <input type="hidden" name="tbl_form_type_id" id="tbl_form_type_id" value="1">
            <input type="hidden" name="tbl_name" id="tbl_name" value="tbl_form_8a">
...
<?php if ($all['status'] != 1 && $all['status'] != 4 && $getPharmacist['is_verify'] == 'yes') {?>
    ...
    <a href="<?php echo base_url(view_form_8a); ?>" class="btn btn-danger  btn-sm" type="button"> <i class="fa fa-chevron-left"> </i> Cancel/Back</a>
          </div>
<?php } else {?>

      <div class="col-xs-12 text-right">
    <a href="<?php echo base_url('view_form_8a'); ?>" class="btn btn-danger  btn-sm" type="button"> <i class="fa fa-chevron-left"> </i> Back</a>
