<div class="content-wrapper">
    ...
    <?php echo form_open_multipart('form_8a/edit_form_8a', 'id="formID"'); ?>
        ...
        <div class="box-body">
          <div class="row">
            ...
            <div class="col-md-12">
                ...
                <input type="hidden" id="tbl_form_type_id" name="tbl_form_type_id" value="1">
...
<div class="col-md-6">
  ...
  <div class="box box-success">
        ...
        <div class="box-body">
          <div class="row">
            <?php $getFormTypeDoc = $this->global->getFormTypeDocForm8a($all['id']);?>
            ...
            <div class="col-md-12">
              ...
              <div class="form-group">
                ...
                <a id="" href="<?php echo base_url() . IMG_UPLOAD_PATH . 'form_8a/' . $form_type_docInfo['uploaded_document']; ?>" target="_blank">Click here for Uploaded Document <?php echo $form_type_docInfo['name']; ?></a>
              <?php }?>
                ...
                <input type='hidden' name='tbl_form_8a_apply_documents<?php echo $form_type_docInfo['tblForm8aApplyDocID']; ?>' id='tbl_form_8a_apply_documents<?php echo $form_type_docInfo['tblForm8aApplyDocID']; ?>' value='<?php echo $form_type_docInfo['tblForm8aApplyDocID']; ?>'>

                <!-- <input type='hidden' name='tbl_form_8a_apply_documents[]' id='tbl_form_8a_apply_documents[]' value='<?php echo $form_type_docInfo['tblForm8aApplyDocID']; ?>'> -->
