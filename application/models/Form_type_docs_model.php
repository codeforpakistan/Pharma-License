<?php
class Form_type_docs_model extends CI_Model {
	public function __construct() {
		$this->load->database();
		//////// ajax and ssp////////
		// Set table name
		$this->table = 'tbl_form_type_doc';
		// Set orderable column fields
		$this->column_order = array(null, 'name', 'status');
		// Set searchable column fields
		$this->column_search = array('tag_name', 'name');
		// Set default order
	...
	public function add_form_type_docs() {
		...
		$data = array(
			...
			'tag_name' => ucwords(str_replace(' ', '_', $this->input->post('name'))),
		...
		//insertion in db
		$this->db->insert('tbl_form_type_doc', $data);
	...
	public function update_form_type_docs() {
		...
		$result = $this->db->update('tbl_form_type_doc', $data);
		if ($result == true) {
			return true;
		} else {
			return false;
